...
@section('content')
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{route('home')}}">ESAS SEYIFE</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{$rengler->reng_ad}}</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">{{$rengler->reng_ad}}</h2></div>
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    @foreach($reng as $rengcek)
                      <a class="dropdown-item" href="{{url('/renglist/'.$rengcek->id)}}">{{$rengcek->reng_ad}}</a>
