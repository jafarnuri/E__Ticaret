...
@section('content')
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{url('/')}}">{{__('msg.home')}}</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{__('msg.about')}}</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="{{asset('/')}}frondend/images/blog_1.jpg" alt="Image placeholder" class="img-fluid rounded">
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{asset('/')}}frondend/images/person_1.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{asset('/')}}frondend/images/person_2.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{asset('/')}}frondend/images/person_3.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{asset('/')}}frondend/images/person_4.jpg" alt="Image placeholder" class="mb-4">
