          ...
          @if(Session::has("status"))
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" value="{{$mehsullar->mehsul_endirim_tarix}}" name="mehsul_endirim_tarix" placeholder="Ürün fiyat giriniz"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
